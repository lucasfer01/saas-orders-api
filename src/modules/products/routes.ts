    ...
    app.post(
        "/products",
        {
            preHandler: [
                ...
                async (req) => app.requireRole(["ADMIN", "MANAGER"])(req),
            ],
        },
        async (req, reply) => {
            ...
            const product = await app.prisma.product.create({
                data: { tenantId, name: body.name, priceCents: body.priceCents, active: body.active ?? true },
                select: { id: true, tenantId: true, name: true, priceCents: true, active: true, createdAt: true },
            });
